import React, { useState, lazy, Suspense, Fragment, memo } from 'react';
import PropTypes from 'prop-types';
import { Tooltip, Carousel, DatePicker, Radio, Button, Rate, Select, Input, Spin, Image } from 'antd';
import { FilePdfOutlined, DownloadOutlined, ReloadOutlined, LoadingOutlined, FileImageOutlined, FileOutlined } from '@ant-design/icons';
  ...
  if (Array.isArray(payload.text) && payload.text.length > 0) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        disableHtmlParser ? msgText : React.createElement('span', { dangerouslySetInnerHTML: { __html: msgText } })
      ),
...
var TextWithMediaBody = function TextWithMediaBody(_ref) {
  ...
  return React.createElement(
    ...
    payload.url && React.createElement('iframe', {
      title: 'video-message',
      width: '100%',
      src: payload.url,
      frameBorder: '0',
    ...
    React.createElement(
      Suspense,
      { fallback: null },
      payload.imageUrl && React.createElement(ImageItem, { src: payload.imageUrl }),
      (payload.title || payload.subtitle) && React.createElement(Header, { title: payload.title, subtitle: payload.subtitle }),
      payload.options && payload.options.length > 0 && React.createElement(CheckboxGroup, {
        options: payload.options,
        disabled: checkboxDisabled,
        onSubmit: onSubmitCheckbox
      }),
      payload.list && payload.list.length > 0 && React.createElement(ListItem, { list: payload.list }),
      !btnHidden && payload.buttons && payload.buttons.length > 0 && React.createElement(Buttons, {
...
var Buttons$1 = lazy(function () {
  return Promise.resolve().then(function () { return index; });
});
var Header$1 = lazy(function () {
  return Promise.resolve().then(function () { return index$1; });
});
...
var CarouselItem = function CarouselItem(_ref) {
  ...
  return React.createElement(
    ...
    carousel.mediaType && carousel.mediaUrl && carousel.mediaType === 'video' && React.createElement('iframe', {
      title: 'video-message',
      src: carousel.mediaUrl,
      width: '100%',
      frameBorder: '0',
    ...
    (carousel.title || carousel.subtitle) && React.createElement(
      Suspense,
      { fallback: null },
    ...
    carousel.buttons && carousel.buttons.length > 0 && React.createElement(
      Suspense,
      { fallback: null },
      React.createElement(Buttons$1, {
        className: 'ori-pad-5',
...
var Buttons$2 = lazy(function () {
  return Promise.resolve().then(function () { return index; });
});
var Header$2 = lazy(function () {
  return Promise.resolve().then(function () { return index$1; });
});
...
var CarouselBody = function CarouselBody(_ref) {
  ...
  return React.createElement(
    ...
    (payload.title || payload.subtitle) && React.createElement(
      Suspense,
      { fallback: null },
      React.createElement(Header$2, { title: payload.title, subtitle: payload.subtitle })
    ),
    payload && payload.options && payload.options.length > 0 && React.createElement(
      Carousel,
      {
        ...
        nextArrow: React.createElement(Arrow, { text: 'Next', align: { right: 0 } }),
        prevArrow: React.createElement(Arrow, { text: 'Prev', align: { left: 0 } }),
        arrows: true,
        autoplay: true,
        pauseOnHover: true
      },
    ...
    !btnHidden && payload.buttons && payload.buttons.length > 0 && React.createElement(
      Suspense,
      { fallback: null },
      React.createElement(Buttons$2, {
        buttons: payload.buttons,
        message: message,
        disabled: btnDisabled,
        onClick: handleMsgBtnClick
...
var CarouselWithButtons = function CarouselWithButtons(_ref) {
  ...
  var _useState = useState({ visible: false, carousel: null }),
      _useState2 = slicedToArray(_useState, 2),
  ...
  return React.createElement(
    React.Fragment,
    null,
    overlay.visible && overlay.carousel && React.createElement(
      Suspense,
      { fallback: null },
      React.createElement(
        Overlay,
...
var Buttons$3 = lazy(function () {
  return Promise.resolve().then(function () { return index; });
});
var Header$3 = lazy(function () {
  return Promise.resolve().then(function () { return index$1; });
});
...
var FormMessageBody = function FormMessageBody(_ref) {
  ...
  var _useState = useState(payload.selectedValues || {}),
      _useState2 = slicedToArray(_useState, 2),
      selectedValues = _useState2[0],
      setSelectedValues = _useState2[1];

  var _useState3 = useState(payload.defaultDisabled),
  ...
  return React.createElement(
    ...
    React.createElement(
      Suspense,
      { fallback: null },
      (payload.title || payload.subtitle) && React.createElement(Header$3, { title: payload.title, subtitle: payload.subtitle })
    ),
    payload.formData && payload.formData.length > 0 && React.createElement(
      React.Fragment,
      null,
        ...
        switch (item.type) {
          ...
          case 'rating':
            return React.createElement(
              ...
              React.createElement(Rate, _extends({}, item.props, {
                disabled: disabled || defaultDisabled,
                value: selectedValues[item.props.name],
                onChange: function onChange(value) {
                  return handleFormChange(defineProperty({}, item.props.name, value), item.props.name);
    ...
    React.createElement(
      Suspense,
      { fallback: null },
      !btnHidden && payload.buttons && payload.buttons.length > 0 && React.createElement(Buttons$3, {
        buttons: payload.buttons,
        message: message,
...
var UploadedDocumentBody = function UploadedDocumentBody(_ref) {
  ...
  var renderFileIcon = function renderFileIcon(fileType) {
    ...
    if (fileType.indexOf('image/') !== -1) {
      return React.createElement(FileImageOutlined, { className: 'ori-font-lg' });
    } else if (fileType === 'application/pdf') {
      return React.createElement(FilePdfOutlined, { className: 'ori-font-lg' });
    } else {
      return React.createElement(FileOutlined, { className: 'ori-font-lg' });
    }
  };

  var checkStatusAndRenderIcon = function checkStatusAndRenderIcon() {
    if (message.status === 'pending') return React.createElement(Spin, { indicator: antIcon });else if (message.status === 'failed') {
      return React.createElement(ReloadOutlined, { className: 'ori-font-lg', onClick: onClickRetry });
    } else {
      return React.createElement(DownloadOutlined, { className: 'ori-font-lg', onClick: onClickDownload });
    }
  };
  ...
  return React.createElement(
    'div',
    null,
    payload.fileType.indexOf('image/') !== -1 && payload.fileUrl && !payload.isDownloadable && React.createElement(
      Suspense,
      { fallback: null },
      React.createElement(ImageItem$1, { src: payload.fileUrl })
    ),
    React.createElement(
      'div',
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          null,
          payload.pages && React.createElement(
            Fragment,
            null,
            React.createElement(
              'span',
          ...
          payload.fileType && React.createElement(
            'span',
            { className: 'ori-uppercase' },
            getFormattedFileType(payload.fileType)
          ),
          payload.fileSize && React.createElement(
            Fragment,
            null,
            React.createElement(
              'span',
...
var ImageItem$2 = memo(function (_ref) {
  var src = _ref.src;
...
export { TextMessage, TextWithMedia, CarouselWithButtons, FormMessage, UploadedDocument };
